...
1. Download `AgeniusNoteLite-Setup-x.y.z.dmg`.
...
- Speech-to-text: `faster-whisper` with VAD on. Auto-detects CUDA float16 (NVIDIA GPU) and falls back to CPU int8.
...
./packaging/build.sh
# Output: dist-build-mac-<stamp>/AgeniusNoteLite-Setup-<version>.dmg
```
